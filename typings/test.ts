...
declare let schema: Joi.Schema;
declare const schemaLike: Joi.SchemaLike;

declare let anySchema: Joi.AnySchema;
declare let numSchema: Joi.NumberSchema;
declare let strSchema: Joi.StringSchema;
declare let arrSchema: Joi.ArraySchema ;
declare let boolSchema: Joi.BooleanSchema;
declare let binSchema: Joi.BinarySchema;
declare let dateSchema: Joi.DateSchema;
declare let funcSchema: Joi.FunctionSchema;
declare let objSchema: Joi.ObjectSchema;
declare let altSchema: Joi.AlternativesSchema;

declare const schemaArr: Joi.Schema[];

declare let ref: Joi.Reference;
declare let description: Joi.Description;

// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---

declare let validOpts: Joi.ValidationOptions;
...
declare let renOpts: Joi.RenameOptions;
...
declare let emailOpts: Joi.EmailOptions;
...
declare let hexOpts: Joi.HexOptions;

hexOpts = { byteAligned: bool };

// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---

declare let ipOpts: Joi.IpOptions;
...
declare let uriOpts: Joi.UriOptions;
...
declare let base64Opts: Joi.Base64Options;

base64Opts = { paddingRequired: bool };

// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---

declare let dataUriOpts: Joi.DataUriOptions;

dataUriOpts = { paddingRequired: bool };

// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---

declare let whenOpts: Joi.WhenOptions;
...
declare let whenSchemaOpts: Joi.WhenSchemaOptions;
...
declare let refOpts: Joi.ReferenceOptions;
...
declare let stringRegexOpts: Joi.StringRegexOptions;
...
declare let schemaMap: Joi.SchemaMap;
